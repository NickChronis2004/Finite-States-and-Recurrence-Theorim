...
\]
then $\Gamma_{{\rm BB},i}$ are double-exponentially suppressed, and even minute vacuum-decay rates satisfy $\Gamma_{{\rm decay},i}\!\gg\!\Gamma_{{\rm BB},i}$. Diamond-weighted observer counts are dominated by ordinary observers prior to decay, avoiding BB dominance while yielding finite, stable probabilities. See Fig.~\ref{fig:global-vs-diamond} for a comparison of this approach with global volume-weighted measures.
