...
\begin{table}[htbp]
    \centering
    \input{ancillary_files/table_toy_summary.tex}
    \caption{
...
connecting microscopic field-theoretic discretization and gravitational entropy bounds, the analysis
motivates the assumption of finite $D$ for a causal patch and demonstrates that recurrence --- global
...
The proposed measure prescription (causal diamond + no--Boltzmann--Brain) offers a way to regulate infinities 
in cosmological settings while avoiding pathologies. 
Future investigations will focus on quantifying recurrence times in explicit toy models and extending the analysis 
...
These findings are now situated within the broader context of prior work.
...
\begin{itemize}[leftmargin=1.2em]
    ...
    Propose that a positive cosmological constant implies a finite-dimensional Hilbert space, with entropy given by the de Sitter horizon area — directly relevant to the CCR setting.
